	...
	blocksy_rand_md5() => [
		...
		'options' => [
			...
			'popup_additional_close_strategy' => [
				'label' => __('Additional Close Trigger', 'blocksy-companion' ),
				'type' => 'ct-select',
				'value' => 'default',
				'design' => 'block',
				'divider' => 'top:full',
				'choices' => blocksy_ordered_keys([
					'default' => __('None', 'blocksy-companion'),
					'form_submit' => __('On form submit', 'blocksy-companion'),
					'button_click' => __('On button click', 'blocksy-companion')
				]),
			],

			blocksy_rand_md5() => [
				'type' => 'ct-condition',
				'condition' => [ 'popup_additional_close_strategy' => 'form_submit' ],
				'options' => [

					blocksy_rand_md5() => [
						'type' => 'ct-notification',
						'text' => __( 'The popup will auto-close if a form submit action is detected inside of it.', 'blocksy-companion' ),
					],
			...
			blocksy_rand_md5() => [
				'type' => 'ct-condition',
				'condition' => [ 'popup_additional_close_strategy' => 'button_click' ],
				'options' => [
					...
					'aditional_close_button_click_selector' => [
						...
						'type' => 'text',
						'value' => '',
						'desc' => __('Set the button class selector that will trigger popup to close.', 'blocksy-companion'),
					],
			...
			blocksy_rand_md5() => [
				'type' => 'ct-condition',
				'condition' => [ 'popup_additional_close_strategy' => 'form_submit|button_click'],
				'options' => [

					'popup_additional_close_submit_delay' => [
						'label' => __( 'Close Trigger Delay', 'blocksy-companion' ),
						'type' => 'ct-number',
						'design' => 'inline',
						'value' => 0,
						'min' => 0,
						'max' => 1000,
						'step' => 0.1,
						'desc' => __('Set the close delay time (in seconds) after the form submit action is detected.', 'blocksy-companion'),
					],
				...
				'options' => [
					...
					blocksy_rand_md5() => [
						...
						'options' => [
							...
							blocksy_rand_md5() => [
								'type' => 'ct-condition',
								'condition' => [ 'popup_additional_close_strategy' => '!default' ],
								'options' => [

									'days_after_success_value' => [
										'label' => [
											__('Days After Form Submit', 'blocksy-companion') => [
												'popup_additional_close_strategy' => 'form_submit'
											],
